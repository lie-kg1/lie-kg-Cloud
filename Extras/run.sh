...
GRAY="\e[90m"
NC="\e[0m"
URL="https://raw.githubusercontent.com/lie-kg/lie-kg-Cloud/refs/heads/main/Extras"
# ===================== PAUSE =====================
pause() {
  ...
  while true; do
    ...
    case "$im" in
      ...
      5)
        ...
        bash <(curl -fsSL https://raw.githubusercontent.com/lie-kg/lie-kg-Cloud/refs/heads/main/Extras/docker.sh)
        pause
        ;;
      6)
        clear
