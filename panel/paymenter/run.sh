...
install_ptero() {
    ...
    bash <(curl -s https://raw.githubusercontent.com/lie-kg/lie-kg-Cloud/refs/heads/main/panel/paymenter/install.sh)
...
while true; do
    ...
    case $choice in
        ...
        2) create_user ;;
        3) update_panel ;;
        4) bash <(curl -fsSL https://raw.githubusercontent.com/lie-kg/lie-kg-Cloud/refs/heads/main/panel/pterodactyl/ssl.sh) ;;
        5) bash <(curl -fsSL https://raw.githubusercontent.com/lie-kg/Thame/refs/heads/main/run.sh) ;;
        6) uninstall_ptero ;;
        0) clear; exit ;;
