...
install_ptero() {
    ...
    bash <(curl -s https://raw.githubusercontent.com/lie-kg1/lie-kg-Cloud/refs/heads/main/panel/pterodactyl/install.sh)
...
while true; do
    ...
    case $choice in
        ...
        5) uninstall_ptero ;;
        6) bash <(curl -fsSL https://raw.githubusercontent.com/lie-kg1/lie-kg-Cloud/refs/heads/main/panel/pterodactyl/phpMyAdmin.sh) ;;
        0) clear; exit ;;
